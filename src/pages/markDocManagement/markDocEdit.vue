<template>
    <div class="markDocEdit">
        ...
        <div class="doc-edit-container" v-loading="markDocStatus"
            ...
            <div class="aside-content-container">
                <aside-tree :start-node.sync="startNode" :start-event.sync="startEvent" :end-event.sync="endEvent"
                            ...
                            :title="markDocAllData.bidDocTitle"
            ...
            <div class="wps-container">
                ...
                <div class="sys-and-wps">
                    <div class="left-sys-wrapper">
                        <!--模板-->
                        <div class="template-module">
                            <el-popover
                                    :visible-arrow="false"
                                    ref="sysTemplatePopper"
                                ...
                                <div class="right-template-fodder">
                                    ...
                                    <img @click="closeSysModal('sysTemplatePopper')" class="pack-up-icon"
                                         src="~/assets/newMarkDoc/back.png" alt="">
                                </div>
                                <div :class="{'show-wrapper':true,'typeActive':resourceType>199&&resourceType<300}"
                                     slot="reference">
                                    <img class="default-icon" src="~/assets/newMarkDoc/moban-default.png" alt="">
                                    <img class="select-icon" src="~/assets/newMarkDoc/moban_seclet.png" alt="">
                                    <div>模板</div>
                                    <div class="blue-sign"></div>
                                </div>
                            ...
                            <el-popover
                                ...
                                <div class="right-template-fodder">
                                    ...
                                    <div class="template-content">
                                        ...
                                        <templateAsideTree :insertImgInfo.sync="insertImgInfo"
                                                           :start-node.sync="startNode" :start-event.sync="startEvent"
                                                           :end-event.sync="endEvent" :preview-info.sync="previewInfo"
                                                           :page-size.sync="pageSize"
                                                           :current-page.sync="currentPage"
                                                           :resourceType.sync="resourceType"
                                    ...
                                    <img @click="closeSysModal('sysFodderPopper')" class="pack-up-icon"
                                         src="~/assets/newMarkDoc/back.png" alt="">
                                </div>
                                <div :class="{'show-wrapper':true,'typeActive':resourceType<199}" slot="reference">
                                    <img class="default-icon" src="~/assets/newMarkDoc/sucai-default.png" alt="">
                                    <img class="select-icon" src="~/assets/newMarkDoc/sucai_seclet.png" alt="">
                                    <div>素材</div>
                                    <div class="blue-sign"></div>
                                </div>
                                ...
                                <div class="right-template-fodder">
                                    ...
                                    <div class="template-content">
                                        <templateAsideTree :start-node.sync="startNode" :start-event.sync="startEvent"
                                                           ...
                                                           :current-page.sync="currentPage"
                                                           :resourceType.sync="resourceType"
                                                           :template-or-fodder-data.sync="templateOrFodderData"></templateAsideTree>
                                    </div>
                                    <img @click="closeSysModal('sysTemplatePopper')" class="pack-up-icon"
                                         src="~/assets/newMarkDoc/back.png" alt="">
                                </div>
                                <div :class="{'show-wrapper':true,'typeActive':resourceType===301}" slot="reference">
                                    <img class="default-icon bigImg"
                                         src="~/assets/newMarkDoc/company_infor_selected@2x.png" alt="">
                                    <img class="select-icon bigImg"
                                         src="~/assets/newMarkDoc/company_infor_unselected@2x.png" alt="">
                                    <div>公司信息</div>
                                    <div class="blue-sign"></div>
                                </div>
                        ...
                        <div class="template-module">
                            <el-popover
                                ...
                                <div :class="{'show-wrapper':true,'typeActive':resourceType===302}" slot="reference">
                                    <img class="default-icon  bigImg"
                                         src="~/assets/newMarkDoc/personnel_unselected@2x.png" alt="">
                                    <img class="select-icon bigImg" src="~/assets/newMarkDoc/personnel_selected@2x.png"
                                         alt="">
                                    <div>人员信息</div>
                                    <div class="blue-sign"></div>
                                </div>
                ...
                <div v-if="sysTemplateOpenFlag||sysFodderOpenFlag" class="mask-layer">
                    <div v-show="previewInfo.catalogName"
                        ...
                        <iframe ref="wpsPage1" src="/wpsPage1" id="previewWpsContainer"
                                class="preview-wps-container"></iframe>
                    </div>
                </div>
            </div>
        </div>
        ...
        <!--资质对话框-第二步-->
        <el-dialog @close="getContentTreeData" class="setPrintDialog outField" width="778px" title="选择人员"
        ...
        <el-dialog class="generate-doc-dialog" width="450px" title="正在生成标书，请稍后..." :visible.sync="generateBidDocFlag">
            <div class="flex-center-wrapper">
                ...
                <img class="generate-waiting-icon" src="../../assets/template/timerLoading.gif" alt=""
        ...
        <!--导出章节对话框-->
        <el-dialog class="generate-doc-dialog" width="450px" title="当前章节正在导出..." :visible.sync="exportSectionFlag">
            <div class="flex-center-wrapper">
                <img class="generate-waiting-icon" src="../../assets/template/timerLoading.gif" alt=""
                     style="width: 60px;height: auto;">
                <div class="generate-waiting-text">系统正在导出您选择的章节，这可能需要一点时间</div>
            </div>
            <div slot="footer" class="dialog-footer">
                <el-button @click="exportSectionFlag = false">留在本页</el-button>
            </div>
        </el-dialog>
        ...
        <commonSetDialog
                :is-bid-doc="true"
                router-type="sysTemplate"
                :type="2"
                :key-id="markDocAllData.bidDocId"
                :setting-flag.sync="setDocToTemplateFlag"
                :current-name="markDocAllData.bidDocTitle"></commonSetDialog>

        <!--图片资质 点击预览对话框-->
        <el-dialog class="img-certification" width="440px" :visible.sync="cerImgDialogFlag">
            <img :src="certificationImg" lazy style="width: 400px;">
        </el-dialog>
...
<script>
    ...
    export default {
        head() {
            return {
                title: this.markDocAllData.bidDocTitle + '-云标书'
            }
        },
        name: 'markDocEdit',
        components: {
        ...
        data() {
            return {
                ...
                insertImgInfo: {},
                //图片资质--点击预览对话框
                cerImgDialogFlag: false,
                certificationImg: '',

                wpsAppOption: null,

                //公司信息和人员信息
                allEnterpriseAndPersonalInfo: {},

                previewWpsInfo: {},

                //将标书存为模板
                setDocToTemplateFlag: false,

                //导出章节弹窗
                exportSectionFlag: false,
                exportTimer: null,
        ...
        watch: {
            fileId: function (val) {
                console.log('hhhhhhhhhhhhhhhhhhhhh',val)
                if (val.length > 0) {
                    const prm = {
                        fileId: val
                    }
                    this.$axios[this.$apiURL.commonApi.getFileUrlByFileId.method](this.$apiURL.commonApi.getFileUrlByFileId.url, {params: prm}).then(async res => {
                        if (res.data.code === 200) {
                            const {result} = res.data

                            this.$refs.sysTemplatePopper.doClose()
                            this.$refs.sysFodderPopper.doClose()
            ...
            previewInfo: function (val) {
                if (val.fileId) {
                    if (val.type === 'company_material_pic') {
                        this.certificationImg = val.fileId
                        this.cerImgDialogFlag = true
                        this.previewInfo = {}
                        return
                    }
                    const prm = {
                    ...
                    this.$axios[this.$apiURL.commonApi.getFileUrlByFileId.method](this.$apiURL.commonApi.getFileUrlByFileId.url, {params: prm}).then(async res => {
                        if (res.data.code === 200) {
                            const {result} = res.data
                            this.previewWpsInfo = result
                            this.$refs.wpsPage1.contentWindow.postMessage({
                                type: 'url',
                                data: result
                            })

                           /* // 获取图形对象
                            const shapes = await this.wpsAppOption.ActiveDocument.Shapes;

                            // 插入非嵌入式图片
                            await shapes.AddPicture({
                                FileName: 'https://img2.baidu.com/it/u=2317087428,1930308137&fm=26&fmt=auto', // 图片地址
                                LinkToFile: true,
            ...
            insertImgInfo: async function (val) {
                if (val.fileId && val.type === 'company_material_pic') {
        ...
        methods: {
            ...
            exportCurrentSection() {
                ...
                this.$axios[this.$apiURL.markDocApi.exportDataById.method](this.$apiURL.markDocApi.exportDataById.url, prm).then(res => {
                    this.$message.success(res.data.msg)
                    this.exportSectionFlag = true
                    this.exportTimer = setInterval(() => {
                        this.$axios[this.$apiURL.markDocApi.getSectionExportStatus.method](this.$apiURL.markDocApi.getSectionExportStatus.url, qs.stringify({
                            exportRecordId: res.data.result,
                            noLoading: true
                        })).then(statusRes => {
                            if (statusRes.data.result.hasOwnProperty(202)) {
                                clearInterval(this.exportTimer)
                                this.exportTimer = null
                                this.$message.success('导出成功')
                                this.exportSectionFlag = false
                                this.exportRecordFlag = true
                            } else if (statusRes.data.result.hasOwnProperty(203)) {
                                clearInterval(this.exportTimer)
                                this.exportTimer = null
            ...
            generateBidDoc() {
                if (this.generateTimer) {
                    this.$message.warnings('当前有标书正在生成中...')
                    return
                }
                const prm = qs.stringify({
                    bidDocId: this.markDocAllData.bidDocId
            ...
            async openWPS(url, token) {
                ...
                this.wpsAppOption = this.wpsOption.Application

                //隐藏 更多、历史记录 按钮
                const HeaderHistoryMenuBtn = await this.wpsAppOption.CommandBars('HeaderHistoryMenuBtn')
                const moreMenus = await this.wpsAppOption.CommandBars('MoreMenus')
                moreMenus.Visible = false
                HeaderHistoryMenuBtn.Visible = false

                //自定义按钮
                const controls = await this.wpsAppOption.CommandBars('StartTab').Controls
                ...
                // 获取登录操作者信息
                // const operatorsInfo = await this.wpsAppOption.ActivePresentation.GetOperatorsInfo();
                // app.ActiveDocument.ActiveWindow.View.Zoom.Percentage = 50
                console.log('app', app, app.ActivePresentation)
            },
            //打开预览wps
            ...
            getTemplateOrFodder() {
                if (this.resourceType > 300) {
                    this.$axios[this.$apiURL.markDocApi.getEnterpriseAndPersonalInfo.method](this.$apiURL.markDocApi.getEnterpriseAndPersonalInfo.url).then(res => {
                        this.allEnterpriseAndPersonalInfo = res.data.result
                        this.templateOrFodderData = this.resourceType === 301 ? this.allEnterpriseAndPersonalInfo.bidCompanyVO.childName : this.allEnterpriseAndPersonalInfo.bidPersonVO.childName
                    })
                } else {
                    const prm = {
                        callScenario: 1,
            ...
            openHandler(num) {
                if (this.templateOrFodderData.length > 0) {
                    ...
                    if (changeFlag) {
                        ...
                        if (num > 300 && this.allEnterpriseAndPersonalInfo.bidCompanyVO) {
                            this.templateOrFodderData = num === 301 ? this.allEnterpriseAndPersonalInfo.bidCompanyVO.childName : this.allEnterpriseAndPersonalInfo.bidPersonVO.childName
                            this.resourceType = num
                        }
                    }
                } else {
