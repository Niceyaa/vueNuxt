                    ...
                    <div class="left-sys-wrapper">
                        ...
                        <div class="template-module">
                            <el-popover
                                ...
                                <div :class="{'show-wrapper':true,'typeActive':resourceType>199}" slot="reference">
                                    <img class="default-icon bigImg" src="~/assets/newMarkDoc/company_infor_selected@2x.png" alt="">
                                    <img class="select-icon bigImg" src="~/assets/newMarkDoc/company_infor_unselected@2x.png" alt="">
                                    <div>公司信息</div>
                                    <div class="blue-sign"></div>
                                </div>
                        ...
                        <div class="template-module">
                            <el-popover
                                ...
                                <div :class="{'show-wrapper':true,'typeActive':resourceType<199}" slot="reference">
                                    <img class="default-icon  bigImg" src="~/assets/newMarkDoc/personnel_unselected@2x.png" alt="">
                                    <img class="select-icon bigImg" src="~/assets/newMarkDoc/personnel_selected@2x.png" alt="">
                                    <div>人员信息</div>
                                    <div class="blue-sign"></div>
                                </div>
