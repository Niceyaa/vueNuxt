    ...
    <div class="sys-template-container">
        ...
        <div class="search-wrapper">
            <div class="inner-search-wrapper">
                ...
                <el-input class="search-input" v-model="searchKeyword" placeholder="请输入模板关键词">
        ...
        <div v-if="totalTemplateData.length>0">
            <div class="template-lib-show">
                <div class="template-content">
                    <!-- <nuxt-link target="_blank" :to="'/sysTemplate/detail/'+item.templateId" v-for="item in totalTemplateData" :key="item.templateId" class="template-item">
                    ...
                    <div :to="'/sysTemplate/detail/'+item.templateId" v-for="item in totalTemplateData"
                         :key="item.templateId" class="template-item">
                        <div class="show-inner">
                            ...
                            <div class="opt-wrapper">
                                <nuxt-link target="_blank" :to="'/sysTemplate/detail/'+item.templateId"
            ...
            <div v-if="searchKeyword||currentIndustryId||labelIdList.length>0" class="page-wrapper">
                <el-pagination
        ...
        <successShow :show-flag.sync="showFlag">
            <div style="text-align: center">创建成功，可前往
                ...
                或
                <nuxt-link to="/personalCenter/personalCenter/myBidDoc"
                           style="color: #156BFE;text-decoration: none">工作区
                </nuxt-link>
                查看
            </div>
        </successShow>
    ...
    export default {
        ...
        async asyncData(context) {
            try {
                ...
                const labelIdList = context.route.query.label ? [context.route.query.label] : []
                const keyWord = context.route.query.keyword ? context.route.query.keyword : null
                ...
                let totalTemplateData = temp.data.result.list
                return {
        ...
        mounted() {
            ...
            this.labelIdList = this.$route.query.label ? [this.$route.query.label] : []
        },
        methods: {
            changeLabel(item) {
                this.labelIdList = [item.id]
                this.getSysTemplate()
