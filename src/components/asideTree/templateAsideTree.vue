            ...
            <el-tree
                ...
                <div :class="{'custom-tree-node':true,'nodeActive':currentNodeItemId===node.id||currentEditItemId===node.id}"
                    ...
                    <div class="content-item-left">
                        ...
                        <img v-else-if="!data.isDoc&&data.type!=='company_material_perform'&&data.type!=='company_material_personnel_qualification'&&data.type!=='company_material_legal_person'&&data.type!=='company_material_account_permission'&&data.type!=='company_material_business_license'"
                             class="fold-icon"
                             src="@/assets/template/file222.png" alt="">
                        <img class="fold-icon" v-else-if="data.type==='company_material_pic'"
                             src="~/assets/personal2/personal_icon_png@2x.png" alt="">
                    ...
                    <img @click.stop="changeInsertInfo(data)" v-if="data.type==='company_material_pic'" class="preview-doc-icon"
                         src="../../assets/template/picture@2x.png" alt="">
                </div>
            </el-tree>
        </div>
...
<script>
    ...
    export default {
        ...
        methods: {
            changeInsertInfo(info){
                this.$emit('update:insertImgInfo', info)
            },
            getFileId(info) {
